  ...
  return (
    <section className="bg-indigo-50">
        <div className="container m-auto max-w-2xl py-24">
            <div className="bg-white px-6 py-8 mb-4 rounded-md border shadow-md m-4 md:m-0">
                <form onSubmit={submitJob}>
                    ...
                    <div className="mb-4">
                        <label htmlFor="name" className="block text-gray-700 font-bold mb-2">Job Listing Name</label>
                        <input 
                        type="text"
                        id="title"
                        name="title" 
                    ...
                    <div className="mb-4">
                        ...
                        <select
                        id="salary" 
                        name='salary' className="border rounded w-full py-2 px-2" 
                        required
                        value={salary}
                    ...
                    <h3 className="text2-xl mb-5">Company Info</h3>
                    ...
                    <div>
                        <button type="submit" className="bg-indigo-500 text-white font-bold py-2 px-4 rounded-full w-full hover:bg-indigo-600 focus:outline-none focus:shadow-outline">
                            Add Job
                        </button>
                    </div>
                </form>
